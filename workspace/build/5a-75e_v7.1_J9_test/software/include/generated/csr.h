...
#define CSR_MMIO_INST_RESET_ADDR (CSR_BASE + 0x2cL)
...
#define CSR_MMIO_INST_WATCHDOG_DATA_ADDR (CSR_BASE + 0x30L)
...
#define CSR_MMIO_INST_GPIO_OUT_ADDR (CSR_BASE + 0x34L)
...
#define CSR_MMIO_INST_WATCHDOG_HAS_BITTEN_ADDR (CSR_BASE + 0x38L)
...
#define CSR_MMIO_INST_WALL_CLOCK_ADDR (CSR_BASE + 0x3cL)
#define CSR_MMIO_INST_WALL_CLOCK_SIZE 2
static inline uint64_t MMIO_inst_wall_clock_read(void) {
	uint64_t r = csr_read_simple(CSR_BASE + 60L);
	r <<= 32;
	r |= csr_read_simple(CSR_BASE + 0x40L);
	return r;
}
#define CSR_MMIO_INST_GPIO_IN_ADDR (CSR_BASE + 0x44L)
